...
{
  public partial class frmGLAcType : Form
  {
    ...
    private void AtFormLoad()
    {
        ...
        //
        rBtn_BalanceSheet.Checked = true;
            ...
            else
            {
                if (Convert.ToInt64(mtextID.Text) > 0)    // Selected large int so that it may not conflict with int16, int32 etc
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (Convert.ToInt16(dRow.ItemArray.GetValue(3)) == 1)
                            {
                                rBtn_Revenue.Checked = true;
                                rBtn_BalanceSheet.Checked = false;
                            }
                            else
                            {
                                rBtn_Revenue.Checked = false;
                                rBtn_BalanceSheet.Checked = true;
                            }
                        }
                        else
                        ...
                        {
                            if (Convert.ToBoolean(dRow.ItemArray.GetValue(4).ToString()))
                            {
                                rBtn_Credit.Checked = true;
                                rBtn_Debit.Checked = false;
                            }
                            else
                            {
