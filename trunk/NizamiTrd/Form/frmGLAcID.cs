    ...
    public partial class frmGLCOA : Form
    {
        ...
        private void btn_PinParentID_Click(object sender, EventArgs e) 
        {
            if (btn_PinParentID.Text == "&Pin")
            {
                ...
                btn_PinParentID.Image = TaxSolution.Properties.Resources.tiny_pinned;
                mtextParentID.Enabled = false;
            }
            else
            {
                btn_PinParentID.Text = "&Pin";
                btn_PinParentID.Image = TaxSolution.Properties.Resources.tiny_pin;
                mtextParentID.Enabled = true;
            }
        }
        ...
        private void btn_PinID_Click(object sender, EventArgs e)
        {
            if (btn_PinID.Text == "&Pin")
            {
                ...
                btn_PinID.Image = TaxSolution.Properties.Resources.tiny_pinned;
                gbPin.Enabled = false;
            }
            else
            {
                btn_PinID.Text = "&Pin";
                btn_PinID.Image = TaxSolution.Properties.Resources.tiny_pin;
                gbPin.Enabled = true;
            }
        }
        //
